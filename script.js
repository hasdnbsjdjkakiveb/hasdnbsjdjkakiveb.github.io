...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ===================================
    // FORM SUBMISSION WITH AJAX (NO FORMSPREE REDIRECT)
    // ===================================
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', async function(e) {
            ...
            if (!formAction || formAction.includes('YOUR_FORM_ID')) {
                alert('Please update YOUR_FORM_ID in the form action with your actual Formspree form ID.');
                return;
            }
            ...
            try {
                // Submit form via AJAX to prevent Formspree redirect
